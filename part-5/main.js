...
//Slice & Splice.
let groceryList2 = groceryList.slice(1, 3);
...
//Tuples.
let lunchOrder = ["Biryani", "Raita"];
//Enums/
var primitiveDataTypes;
(function (primitiveDataTypes) {
    primitiveDataTypes[primitiveDataTypes["string"] = 0] = "string";
    primitiveDataTypes[primitiveDataTypes["number"] = 1] = "number";
    primitiveDataTypes[primitiveDataTypes["boolean"] = 2] = "boolean";
    primitiveDataTypes[primitiveDataTypes["any"] = 3] = "any";
})(primitiveDataTypes || (primitiveDataTypes = {}));
;
let tsDataTypes = primitiveDataTypes.number;
